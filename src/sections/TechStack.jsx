...
const techStackModels = [
  ...
  { modelPath: `${BASE_URL}/models/cloud.glb`, scale: 1.2, rotation: [0, -Math.PI / 2, 0] },
  { modelPath: `${BASE_URL}/models/modeling.glb`, scale: 1, rotation: [0, 0, 0] },
  { modelPath: `${BASE_URL}/models/sql.glb`, scale: 5, rotation: [0, -Math.PI / 4, 0] },
  { modelPath: `${BASE_URL}/models/tube.glb`, scale: 0.7, rotation: [0, 0, 0] },
];
